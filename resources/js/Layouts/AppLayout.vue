                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('companies.index')" :active="route().current('companies.*')"> Empresas </NavLink>
                                <NavLink :href="route('polls.index')" :active="route().current('polls.*')"> Encuestas </NavLink>
                            </div>
                        </div>
