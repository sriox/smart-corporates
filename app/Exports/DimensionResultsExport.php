...
class DimensionResultsExport implements FromView, WithHeadings, WithTitle, ShouldAutoSize, WithStyles
{
    private $group;
    ...
    public function view(): View
    {
        ...
        return view('Exports.DimensionResults', compact('results', 'groupData', 'dimensions', 'colors'));
    }
    ...
    public function collection()
    {
        ...
        $collection = array_map(function ($reg) {
            ...
            return [$reg->group, $reg->dimension, $reg->result];
        }, $data);
    ...
    {
        $query = str_replace('{{$var}}', $this->group, file_get_contents(app_path('Queries/dimension_results.sql')));
    ...
    {
        $colName = DemographicsMap::getColumnName($this->group);
        $title = "Resultados por {$colName} - Área";
        return $title;
    }
